    ...
    <nav className="navbar">
      <div className="navbar-container container">
        ...
        <div className="navbar-icons">
          <a href="#account" className="icon-text-link">
      ...
      <div className={`mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
        ...
        <a href="#account" className="mobile-nav-link" onClick={() => setMobileMenuOpen(false)}>Account</a>
        <button className="mobile-nav-link mobile-search-link" onClick={() => { setMobileMenuOpen(false); onSearchClick(); }}>Search</button>
      </div>
    </nav>
  );
};
